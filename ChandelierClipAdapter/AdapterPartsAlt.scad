...
)
{
	...
	union()
	{
		difference()
		{
			...
			rotate(a=-45, v=[0,0,1])
			translate([0,0,(metal_bar_size[1]*2+cutClr)/2+base_height-metal_bar_size[1]*2])
			{
				//metal bar top cut
				cube(size=[ext_diameter*2,metal_bar_size[0],metal_bar_size[1]*2+cutClr],center=true);
			}
